use std::{collections::HashSet, ops::AddAssign, time::Instant};
...
fn do_day9_part2(input: &str) -> u32 {
    let mut head = Vec2::new(0, 0);
...
R 2";
        ...
        assert_eq!(do_day9_part1(input), 13);
    }
    #[test]
    fn part_2() {
        use super::do_day9_part2;
        ...
        L 25
        U 20";
        assert_eq!(do_day9_part2(input), 36)
    }
}
